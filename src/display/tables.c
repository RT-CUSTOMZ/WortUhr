...
const struct WordIllu illumination[WP_COUNT]=
{
    ...
    {  6, 14,  4 },                                                                         // 38 = WP_NACH_1           = "NACH"
    {  7,  0,  5 },                                                                         // 39 = WP_WOCHE            = "WOCHE"
    {  7,  0,  6 },                                                                         // 40 = WP_WOCHEN           = "WOCHEN"
    {  7,  6,  6 },                                                                         // 41 = WP_IST              = "IST"
    {  7,  8,  3 },                                                                         // 42 = WP_TAG              = "TAG"
    {  7,  8,  5 },                                                                         // 43 = WP_TAGEN            = "TAGEN"
    {  7, 13,  6 },                                                                         // 44 = WP_KAFFEE           = "KAFFEE"
    {  8,  0,  3 },                                                                         // 45 = WP_EIN_3            = "EIN"
    {  8,  3, 11 },                                                                         // 46 = WP_DREIVIERTEL      = "DREIVIERTEL"
    {  8,  7,  7 },                                                                         // 47 = WP_VIERTEL_2        = "VIERTEL"
    {  8, 14,  4 },                                                                         // 48 = WP_HALB             = "HALB"
    {  9,  0,  4 },                                                                         // 49 = WP_SIEB_2           = "SIEB"
    {  9,  0,  6 },                                                                         // 50 = WP_SIEBEN_2         = "SIEBEN"
    {  9,  5,  4 },                                                                         // 51 = WP_NEUN_2           = "NEUN"
    {  9,  8,  4 },                                                                         // 52 = WP_NULL_2           = "NULL"
    {  9, 12,  4 },                                                                         // 53 = WP_ZWEI_2           = "ZWEI"
    {  9, 14,  3 },                                                                         // 54 = WP_EIN_4            = "EIN"
    {  9, 14,  4 },                                                                         // 55 = WP_EINE_2           = "EINE"
    { 10,  0,  4 },                                                                         // 56 = WP_FUENF_2          = "FÜNF"
    { 10,  4,  4 },                                                                         // 57 = WP_SECH_2           = "SECH"
    { 10,  4,  5 },                                                                         // 58 = WP_SECHS_2          = "SECHS"
    { 10, 10,  4 },                                                                         // 59 = WP_ACHT_2           = "ACHT"
    { 10, 14,  4 },                                                                         // 60 = WP_VIER_2           = "VIER"
    { 11,  0,  4 },                                                                         // 61 = WP_DREI_2           = "DREI"
    { 11,  2,  3 },                                                                         // 62 = WP_EIN_5            = "EIN"
    { 11,  2,  4 },                                                                         // 63 = WP_EINS_2           = "EINS"
    { 11,  6,  3 },                                                                         // 64 = WP_UND_3            = "UND"
    { 11, 10,  3 },                                                                         // 65 = WP_ELF_2            = "ELF"
    { 11, 14,  4 },                                                                         // 66 = WP_ZEHN_2           = "ZEHN"
    { 12,  0,  7 },                                                                         // 67 = WP_ZWANZIG_2        = "ZWANZIG"
    { 12,  7,  4 },                                                                         // 68 = WP_GRAD             = "GRAD"
    { 12, 10,  8 },                                                                         // 69 = WP_DREISSIG_2       = "DREISSIG"
    { 13,  0,  7 },                                                                         // 70 = WP_VIERZIG_2        = "VIERZIG"
    { 13,  7,  5 },                                                                         // 71 = WP_ZWOELF_2         = "ZWÖLF"
    { 13, 11,  7 },                                                                         // 72 = WP_FUENFZIG_2       = "FÜNFZIG"
    { 14,  0,  6 },                                                                         // 73 = WP_MINUTE_2         = "MINUTE"
    { 14,  0,  7 },                                                                         // 74 = WP_MINUTEN_2        = "MINUTEN"
    { 14,  7,  3 },                                                                         // 75 = WP_IST_3            = "IST"
    { 14, 10,  3 },                                                                         // 76 = WP_UHR_2            = "UHR"
    { 14, 13,  6 },                                                                         // 77 = WP_FERTIG           = "FERTIG"
    { 15, 0,  4 },                                                                          // 78 = WP_FRUEH            = "FRÜH"
    { 15, 4,  11 },                                                                         // 79 = WP_CAMPUSWOCHE      = "CAMPUSWOCHE"
    { 15, 15,  3 },                                                                         // 80 = WP_VOR_2            = "VOR"
    { 16,  0,  6 },                                                                         // 81 = WP_ABENDS           = "ABENDS"
    { 16,  6, 11 },                                                                         // 82 = WP_MITTERNACHT      = "MITTERNACHT"
    { 16, 12,  4 },                                                                         // 83 = WP_NACH_2           = "NACH"
    { 16, 12,  6 },                                                                         // 84 = WP_NACHTS           = "NACHTS"
    { 17,  0,  7 },                                                                         // 85 = WP_MORGENS          = "MORGENS"
    { 17,  7,  4 },                                                                         // 86 = WP_WARM             = "WARM"
    { 17, 11,  7 },                                                                         // 87 = WP_MITTAGS          = "MITTAGS"
 };
