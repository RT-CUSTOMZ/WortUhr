...
enum WordPos
{
    ...
    WP_WOCHEN,                                                  // 37 = "35_WOCHEN" = "WOCHEN"
    WP_IST_2,                                                   // 38 = "35_IST" = "IST"
    WP_TAG,                                                     // 39 = "35_TAG" = "TAG"
    WP_TAGEN,                                                   // 39 = "35_TAGEN" = "TAGEN"
    WP_KAFFEE,                                                  // 40 = "35_KAFFEE" = "KAFFEE"
    WP_EIN_3,                                                   // 41 = "35_EIN" = "EIN"
    WP_DREIVIERTEL,                                             // 42 = "36_DREIVIERTEL" = "DREIVIERTEL"
    WP_VIERTEL_2,                                               // 43 = "37_VIERTEL" = "VIERTEL"
    WP_HALB,                                                    // 44 = "38_HALB" = "HALB"
    WP_SIEB_2,                                                  // 45 = "39_SIEB" = "SIEB"
    WP_SIEBEN_2,                                                // 46 = "40_SIEBEN" = "SIEBEN"
    WP_NEUN_2,                                                  // 47 = "41_NEUN" = "NEUN"
    WP_NULL_2,                                                  // 48 = "42_NULL" = "NULL"
    WP_ZWEI_2,                                                  // 49 = "43_ZWEI" = "ZWEI"
    WP_EIN_4,                                                   // 50 = "44_EIN" = "EIN"
    WP_EINE_2,                                                  // 51 = "45_EINE" = "EINE"
    WP_FUENF_2,                                                 // 52 = "46_FUENF" = "FÜNF"
    WP_SECH_2,                                                  // 43 = "47_SECH" = "SECH"
    WP_SECHS_2,                                                 // 54 = "48_SECHS" = "SECHS"
    WP_ACHT_2,                                                  // 55 = "49_ACHT" = "ACHT"
    WP_VIER_2,                                                  // 56 = "50_VIER" = "VIER"
    WP_DREI_2,                                                  // 57 = "51_DREI" = "DREI"
    WP_EIN_5,                                                   // 58 = "52_EIN" = "EIN"
    WP_EINS_2,                                                  // 59 = "53_EINS" = "EINS"
    WP_UND_3,                                                   // 60 = "54_UND" = "UND"
    WP_ELF_2,                                                   // 61 = "55_ELF" = "ELF"
    WP_ZEHN_2,                                                  // 62 = "56_ZEHN" = "ZEHN"
    WP_ZWANZIG_2,                                               // 63 = "57_ZWANZIG" = "ZWANZIG"
    WP_GRAD,                                                    // 64 = "58_GRAD" = "GRAD"
    WP_DREISSIG_2,                                              // 65 = "59_DREISSIG" = "DREISSIG"
    WP_VIERZIG_2,                                               // 66 = "60_VIERZIG" = "VIERZIG"
    WP_ZWOELF_2,                                                // 67 = "61_ZWÖLF" = "ZWÖLF"
    WP_FUENFZIG_2,                                              // 68 = "62_FUENFZIG" = "FÜNFZIG"
    WP_MINUTE_2,                                                // 69 = "63_MINUTE" = "MINUTE"
    WP_MINUTEN_2,                                               // 70 = "64_MINUTEN" = "MINUTEN"
    WP_IST_3,                                                   // 71 = "65_IST" = "IST"
    WP_UHR_2,                                                   // 72 = "65_UHR" = "UHR"
    WP_FERTIG,                                                  // 73 = "65_FERTIG" = "FERTIG"
    WP_FRUEH,                                                   // 74 = "66_FRUEH" = "FRÜH"
    WP_CAMPUSWOCHE,                                             // 75 = "66_CAMPUSWOCHE" = "CAMPUSWOCHE"
    WP_VOR_2,                                                   // 76 = "67_VOR" = "VOR"
    WP_ABENDS,                                                  // 77 = "68_ABENDS" = "ABENDS"
    WP_MITTERNACHT,                                             // 78 = "69_MITTERNACHT" = "MITTERNACHT"
    WP_NACH_2,                                                  // 79 = "70_NACH" = "NACH"
    WP_NACHTS,                                                  // 80 = "71_NACHTS" = "NACHTS"
    WP_MORGENS,                                                 // 81 = "72_MORGENS" = "MORGENS"
    WP_WARM,                                                    // 82 = "73_WARM" = "WARM"
    WP_MITTAGS,                                                 // 83 = "74_MITTAGS" = "MITTAGS"
