...
enum WordPos
{
    ...
    WP_WOCHE,                                                   // 37 = "35_WOCHE" = "WOCHE"
    WP_WOCHEN,                                                  // 38 = "35_WOCHEN" = "WOCHEN"
    WP_IST_2,                                                   // 39 = "35_IST" = "IST"
    WP_TAG,                                                     // 40 = "35_TAG" = "TAG"
    WP_TAGEN,                                                   // 41 = "35_TAGEN" = "TAGEN"
    WP_KAFFEE,                                                  // 42 = "35_KAFFEE" = "KAFFEE"
    WP_EIN_3,                                                   // 43 = "35_EIN" = "EIN"
    WP_DREIVIERTEL,                                             // 44 = "36_DREIVIERTEL" = "DREIVIERTEL"
    WP_VIERTEL_2,                                               // 45 = "37_VIERTEL" = "VIERTEL"
    WP_HALB,                                                    // 46 = "38_HALB" = "HALB"
    WP_SIEB_2,                                                  // 47 = "39_SIEB" = "SIEB"
    WP_SIEBEN_2,                                                // 48 = "40_SIEBEN" = "SIEBEN"
    WP_NEUN_2,                                                  // 49 = "41_NEUN" = "NEUN"
    WP_NULL_2,                                                  // 50 = "42_NULL" = "NULL"
    WP_ZWEI_2,                                                  // 51 = "43_ZWEI" = "ZWEI"
    WP_EIN_4,                                                   // 52 = "44_EIN" = "EIN"
    WP_EINE_2,                                                  // 53 = "45_EINE" = "EINE"
    WP_FUENF_2,                                                 // 54 = "46_FUENF" = "FÜNF"
    WP_SECH_2,                                                  // 55 = "47_SECH" = "SECH"
    WP_SECHS_2,                                                 // 56 = "48_SECHS" = "SECHS"
    WP_ACHT_2,                                                  // 57 = "49_ACHT" = "ACHT"
    WP_VIER_2,                                                  // 58 = "50_VIER" = "VIER"
    WP_DREI_2,                                                  // 59 = "51_DREI" = "DREI"
    WP_EIN_5,                                                   // 60 = "52_EIN" = "EIN"
    WP_EINS_2,                                                  // 61 = "53_EINS" = "EINS"
    WP_UND_3,                                                   // 62 = "54_UND" = "UND"
    WP_ELF_2,                                                   // 63 = "55_ELF" = "ELF"
    WP_ZEHN_2,                                                  // 64 = "56_ZEHN" = "ZEHN"
    WP_ZWANZIG_2,                                               // 65 = "57_ZWANZIG" = "ZWANZIG"
    WP_GRAD,                                                    // 66 = "58_GRAD" = "GRAD"
    WP_DREISSIG_2,                                              // 67 = "59_DREISSIG" = "DREISSIG"
    WP_VIERZIG_2,                                               // 68 = "60_VIERZIG" = "VIERZIG"
    WP_ZWOELF_2,                                                // 69 = "61_ZWÖLF" = "ZWÖLF"
    WP_FUENFZIG_2,                                              // 70 = "62_FUENFZIG" = "FÜNFZIG"
    WP_MINUTE_2,                                                // 71 = "63_MINUTE" = "MINUTE"
    WP_MINUTEN_2,                                               // 72 = "64_MINUTEN" = "MINUTEN"
    WP_IST_3,                                                   // 73 = "65_IST" = "IST"
    WP_UHR_2,                                                   // 74 = "65_UHR" = "UHR"
    WP_FERTIG,                                                  // 75 = "65_FERTIG" = "FERTIG"
    WP_FRUEH,                                                   // 76 = "66_FRUEH" = "FRÜH"
    WP_CAMPUSWOCHE,                                             // 77 = "66_CAMPUSWOCHE" = "CAMPUSWOCHE"
    WP_VOR_2,                                                   // 78 = "67_VOR" = "VOR"
    WP_ABENDS,                                                  // 79 = "68_ABENDS" = "ABENDS"
    WP_MITTERNACHT,                                             // 80 = "69_MITTERNACHT" = "MITTERNACHT"
    WP_NACH_2,                                                  // 81 = "70_NACH" = "NACH"
    WP_NACHTS,                                                  // 82 = "71_NACHTS" = "NACHTS"
    WP_MORGENS,                                                 // 83 = "72_MORGENS" = "MORGENS"
    WP_WARM,                                                    // 84 = "73_WARM" = "WARM"
    WP_MITTAGS,                                                 // 85 = "74_MITTAGS" = "MITTAGS"
    WP_TEQUILA,                                                 // 86 = "86_TEQUILA" = "TEQUILA"
    WP_BIER,                                                    // 87 = "87_BIER" = "BIER"
    WP_GIN,                                                     // 88 = "88_GIN" = "GIN"
