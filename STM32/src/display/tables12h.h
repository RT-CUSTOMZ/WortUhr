...
#define MODES_COUNT             10                      // 4 german, 2 swiss, 2 english, 1 swedish, 1 french
#define MINUTE_COUNT            12

#define HOUR_MODES_COUNT        11                      // 2 german, 1 swiss1, 1 swiss2, 2 english1, 2 english2, 1 swedish, 2 french (am and pm)
#define HOUR_COUNT              12
#define MAX_HOUR_WORDS          3                       // max is 3: "five o clock"

#define IT_IS_MODES_COUNT       5
...
#define MDF_IT_IS_SWEDISH       0x03                    // SWEDISH
#define MDF_IT_IS_FRENCH        0x04                    // FRENCH
#define MDF_IT_IS_MASK          0x07                    // 3 bits reserved for it-is language, correct IT_IS_MODES_COUNT if you extend languages!

#define MDF_HOUR_OFFSET_0       0x00
#define MDF_HOUR_OFFSET_1       0x08
#define MDF_HOUR_OFFSET_MASK    0x08                    // 1 bit reserved for hour offset mask

#define MDF_AM_PM_MODE_0        0x00
#define MDF_AM_PM_MODE_1        0x10
#define MDF_AM_PM_MODE_MASK     0x10                    // 1 bit reserved for AM / PM Mode in 12h Clock (needs 2 tables; one for am and the second for pm)
