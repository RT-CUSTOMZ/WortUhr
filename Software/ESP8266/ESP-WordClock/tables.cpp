...
checkfile (const char * fname)
{
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 1");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 2");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 3");
        return 0;
    }
    ...
    for (i = 0; i < local_wp_count; i++)
    {
        ...
        {
            fp.close ();
            Serial.println ("- error: unexpected EOF 4");
            return 0;
        }
        ...
        {
            fp.close ();
            Serial.println ("- error: unexpected EOF 5");
            return 0;
        }
        ...
        if(local_len>127){
          int8_t fix = local_len & 0x00FF;
          local_len = fix;
          if (local_row + abs(local_len) > local_wc_rows)
          {
              fp.close ();
              Serial.print ("- error: row + len = ");
              Serial.println (local_row + abs(local_len));
              return 0;
          }
        }else{
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 6");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 7");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 8");
        return 0;
    }
    ...
    for (i = 0; i < local_display_modes_count; i++)
    {
        ...
        {
            fp.close ();
            Serial.println ("- error: unexpected EOF 9");
            return 0;
        }
        ...
        {
            fp.close ();
            Serial.println ("- error: unexpected EOF 10");
            return 0;
        }
        ...
        {
            fp.close ();
            Serial.println ("- error: unexpected EOF 11");
            return 0;
        }
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 12");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 13");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 14");
        return 0;
    }
    ...
    for (i = 0; i < local_hour_modes_count; i++)
    {
        for (j = 0; j < local_hour_count; j++)
        {
            for (k = 0; k < local_max_hour_words; k++)
            {
                ...
                {
                    fp.close ();
                    Serial.println ("- error: unexpected EOF 15");
                    return 0;
                }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 16");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 17");
        return 0;
    }
    ...
    {
        fp.close ();
        Serial.println ("- error: unexpected EOF 18");
        return 0;
    }
    ...
    for (i = 0; i < local_minute_modes_count; i++)
    {
        for (j = 0; j < local_minute_count; j++)
        {
            ...
            {
                fp.close ();
                Serial.println ("- error: unexpected EOF 19");
                return 0;
            }
            ...
            for (k = 0; k < local_max_minute_words; k++)
            {
                ...
                {
                    fp.close ();
                    Serial.println ("- error: unexpected EOF 20");
                    return 0;
                }
